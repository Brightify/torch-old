...
public class TypeUtilsCompatibility {
    ...
    public static <T> T construct(Class<T> type) {
        Constructor<T> constructor = TypeUtilsCompatibility.getNoArgConstructor(type);
        return TypeUtilsCompatibility.newInstance(constructor);
    }
    ...
    public static List<Property> getProperties(BrightifyFactory factory, Class<?> clazz) {
        List<Property> properties = new ArrayList<Property>();
        getProperties(factory, clazz, properties, clazz);
        return properties;
    }

    private static void getProperties(BrightifyFactory factory, Class<?> clazz, List<Property> properties, Class<?> topClass) {
