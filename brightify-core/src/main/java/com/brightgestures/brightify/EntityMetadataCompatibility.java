 ...
 */
public class EntityMetadataCompatibility<ENTITY> {
    ...
    public EntityMetadataCompatibility(Class<ENTITY> entityClass) {
        ...
        for(Field field : fields) {
            if(!TypeUtilsCompatibility.isOfInterest(field)) {
                continue;
            }
